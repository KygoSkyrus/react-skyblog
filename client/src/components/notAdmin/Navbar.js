                ...
                <div className="nav-wrapper">
                    ...
                    <nav className="navbar px-5">
                        ...
                        <ul className="nav list w-100 t-pl-30 t-pr-30 navbars__list pl-lg-0">
                            ...
                            <li className="nav-item"><Link to="/category/tech">TECH</Link></li>
                            <li className="nav-item"><Link to="/category/travel">TRAVEL</Link></li>
                            <li className="nav-item"><Link to="/category/lifestyle">LIFESTYLE</Link></li>
