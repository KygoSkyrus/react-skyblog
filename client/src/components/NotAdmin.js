...
const NotAdmin = (props) => {
    ...
    return (<>
        <Navbar 
        // finalArr={finalArr} allBlog={allBlog} 
        />

        <Routes>
            <Route path="/" exact element={<Homepage 
            // featuredArray={featuredArray} techArray={techArray} sportsArray={sportsArray} allBlog={allBlog} allCategory={allCategory} todaysArray={todaysArray} catAndCount={catAndCount} politicsArray={politicsArray} trendingArray={trendingArray} popularArray={popularArray} 
            />} />

            <Route path="/:id" exact element={<SingleBlog 
            // allBlog={allBlog} catAndCount={catAndCount} allCategory={allCategory} 
            />} />
